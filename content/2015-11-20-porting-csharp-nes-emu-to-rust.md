...
The net result is that I went back to the drawing board and thought long and hard about what was _actually_ necessary for each component. After a couple of refactorings, I think I landed on a solution that's both cleaner and clearer. Every object has one owner, and I don't do any ref cells or ref counting.
