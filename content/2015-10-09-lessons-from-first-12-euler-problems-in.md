...
_I'm going to be talking about solutions to select problems from the first 12 Euler problems. If you haven't solved these for yourself yet, I highly recommend taking the time to solve them on your own first._
...
So when word got out four years ago about a new systems language called [Rust](https://www.rust-lang.org/), I was intrigued. I mean, it was _new_ and it was called _rust_. Obviously there was some cheekiness involved :)
...
If you're interested, you can grab the [source code to my solutions](https://github.com/sophiajt/rustnewbie).
...
Problems [#5](https://github.com/sophiajt/rustnewbie/blob/master/euler/src/ex5.rs), [#6](https://github.com/sophiajt/rustnewbie/blob/master/euler/src/ex6.rs), and [#7](https://github.com/sophiajt/rustnewbie/blob/master/euler/src/ex7.rs) are all straightforward and don't show off anything new in the language. Let's jump ahead to the next interesting one.
...
Problem [#9](https://github.com/sophiajt/rustnewbie/blob/master/euler/src/ex9.rs) is another solution that's simple and doesn't show off any new features. Moving on.
...
I'm only showing the interesting part of the solution since it's a bit long, but you can read the [whole solution](https://github.com/sophiajt/rustnewbie/blob/master/euler/src/ex11.rs).
...
Again we'll trim down to the interesting parts, since we've seen the prime iterator before, but you can read the [full file](https://github.com/sophiajt/rustnewbie/blob/master/euler/src/ex12.rs).
